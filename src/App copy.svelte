<script>
  ...
  function winResize(e) {
    ...
    //
    if (
      savedInfo.styles.showSideBar &&
      winWidth > savedInfo.styles.widthSidebar
    ) {
...
<div
  id="page"
  style="background-color: {$info.styles
    .backgroundColor};
...
>
  <header
    style="background-color: {$info.styles
      .divColor}; 
                 background-image: {$info.styles
      .headerBackgroundPicture}; 
                 border: {$info.styles
      .borderSize} solid {$info.styles
      .borderColor}; 
                 border-radius: {$info.styles
      .borderRadius};
                 color: {$info.styles
      .textColor}; 
